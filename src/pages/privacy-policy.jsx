const PrivacyPolicy = () => {
  return (
    <div className="bg-white min-h-screen " style={{marginTop:'6%',paddingLeft:'7%',paddingRight:'5%'}}>
...
<li>
<p><strong>Application</strong> refers to dukanBuddy, the software program provided by the Company.</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to About Tomothink Artificial Intelligence Private Limited, PLOT NO 20-A, BJB NAGAR, B J B Nagar, Bhubaneswar, Orissa, India, 751014.</p>
</li>
<li>
...
<ul>
<li>By email: admin@dukanbuddy.com</li>
</ul>
            `,
          }}
        />
